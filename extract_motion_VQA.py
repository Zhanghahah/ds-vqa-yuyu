...
def main(config, label_file):
    ...
    trainset = VideoDataset_NR_SlowFast_feature(config.videos_dir, label_file, transformations_test, resize, config.database)
...
if __name__ == '__main__':
    ...
    label_file_dict = {"Konvid-1k": "KoNViD_1k_mos.csv", "LIVE-VQC": "LIVE-VQC_.csv", "LIVE-Gaming": "LIVE_Gaming.csv", "youtube_ugc": "youtube_ugc_whole.csv"}
    label_file = meta_data_path + label_file_dict[config.database]

    main(config, label_file)