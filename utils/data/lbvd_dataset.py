...
class LBVDDataset(VQADataset):
    def __init__(self, data_path,
        ...
        vis_root = f"{data_path}/LBVD/videos"
        assert os.path.isdir(vis_root), f"LBVDDataset image directory {vis_root} not found, you need to check the image path"

        ann_paths = ["LBVD/videos/LBVD_train_ds.json"]  #  "LBVD_test_ds.json"
        ...
        for ann_path in ann_paths:
            ...
            assert os.path.isfile(ann_path), f"LBVDDataset annotation file {ann_path} not found, you need to identify it from your folder"
