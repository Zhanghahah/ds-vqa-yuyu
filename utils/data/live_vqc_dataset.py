...
class LiveVQCDataset(VQADataset):
    def __init__(self, data_path,
        ...
        vis_root = f"{data_path}/live_vqc/Video"

        assert os.path.isdir(
            vis_root), f"YoutubeUGCataset image directory {vis_root} not found, you need to check the image path"

        feature_root = "/data1/zhangyu/own_data/VQA/live_vqc/live_vqc_feature_1fps"
        self.save_video_feat = save_video_feat
        ann_paths = ["live_vqc/Video/LIVE-VQC_train_ds.json",
                     "live_vqc/Video/LIVE-VQC_test_ds.json"]  # "LBVD_test_ds.json"
        ...
        for ann_path in ann_paths:
            ...
            assert os.path.isfile(
                ann_path), f"LiveVQCData annotation file {ann_path} not found, you need to identify it from your folder"
