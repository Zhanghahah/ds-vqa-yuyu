...
class KVQDataset(VQADataset):
    def __init__(self, data_path,
        ...
        vis_root = f"{data_path}/KVQ/train/train"
        assert os.path.isdir(vis_root), f"KVQDataset image directory {vis_root} not found, you need to check the image path"

        feature_root = "/data1/zhangyu/own_data/VQA/KVQ/kvq_feature_1fps/"
        self.save_video_feat = save_video_feat
        ann_paths = ["KVQ/a_split_metadata/KVQ_train_ds_score.json"]  #  "LBVD_test_ds.json"
        ...
        for ann_path in ann_paths:
            ...
            assert os.path.isfile(ann_path), f"KVQDataset annotation file {ann_path} not found, you need to identify it from your folder"
