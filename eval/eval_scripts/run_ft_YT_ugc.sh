...
CKPT_PATH=ds-vqa-output/DATE06-20-ft-YT-ugc_Epoch10_LR1e-3_data_kvq_all_1
...
EVAL_ROOT=own_data/VQA/youtube_ugc/h264
FEATURE_ROOT=own_data/VQA/youtube_ugc/youtube_ugc_feature_1fps
MOTION_ROOT=own_data/VQA/youtube_ugc/youtube_ugc_SlowFast2_feature
mkdir -p ${SAVE_PATH}
