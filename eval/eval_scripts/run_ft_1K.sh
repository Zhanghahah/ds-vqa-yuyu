...
CKPT_PATH=/data2/zhangyu/ds-vqa-output/DATE06-20-ft_Epoch10_LR1e-3_data_kvq_all_1
...
EVAL_ROOT=/data/zhangyu/own_data/VQA/1K/KoNViD_1k_videos
FEATURE_ROOT=/data1/zhangyu/own_data/VQA/1K/1k_feature_1fps
MOTION_ROOT=/data/zhangyu/own_data/VQA/1K/KoNViD_1k_SlowFast2_feature
mkdir -p ${SAVE_PATH}
