...
CKPT_PATH=output/DATE02-19_Epoch10_LR1e-3_data_lsvq_align_all_1
CKPT_NAMES="epoch-6 epoch-7 epoch-8"
VISION_MODEL=public_models/models--openai--clip-vit-large-patch14
LLM=own_data/public_models/Llama-2-7b-hf #meta-llama/Llama-2-7b
...
export CUDA_VISIBLE_DEVICES=0; python3 generation_dynamic_frames.py --model_name dsvl --vis_proj vit --max_seq_len 4096 \
    ...
    --eval_feat own_data/VQA/youtube_ugc/youtube_ugc_feature_1fps \
