...
def main(config):
    ...
    testset = VideoDataset_NR_LSVQ_SlowFast_feature(config.videos_dir, datainfo_test, transformations_test, resize)
    testset_1080p = VideoDataset_NR_LSVQ_SlowFast_feature(config.videos_dir, datainfo_test_1080p, transformations_test, resize, is_test_1080p = True)
